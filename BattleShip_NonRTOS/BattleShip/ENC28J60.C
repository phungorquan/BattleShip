...
void SPI_WRITE(uint8_t data)
{
  ...
  SPI_WRITE_TX(SPI0, (uint8_t)data);
...
//   unsigned long i;
   ...
   enc28j60WriteOp(ENC28J60_BIT_FIELD_SET, MACON3, MACON3_PADCFG0 | MACON3_TXCRCEN | MACON3_FRMLNEN);// Xiu edit | MACON3_FULDPX);
